...
toast.success('logout successfully')
    ...
    useEffect(()=>{
      const getmovies = async()=>{
        await axios.get('https://moviefind-6kpj.onrender.com/movie/get')
        .then((response)=>{
...
const trending = async(e)=>{
  e.preventDefault()
  await axios.post('https://moviefind-6kpj.onrender.com/movie/trending',{
    movienames,
  movielanguage,
  image,
  },{
  ...
  useEffect(()=>{
    ...
    await axios.get('https://moviefind-6kpj.onrender.com/movie/gettrend')
     .then((response)=>{
